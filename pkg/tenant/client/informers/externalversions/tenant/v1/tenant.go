...
import (
	...
	tenantv1 "github.com/GoogleCloudPlatform/gke-enterprise-mt/pkg/apis/tenant/v1"
	...
	v1 "github.com/GoogleCloudPlatform/gke-enterprise-mt/pkg/tenant/client/listers/tenant/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.TenancyV1().Tenants(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TenancyV1().Tenants(namespace).Watch(context.TODO(), options)
			},
		},
		&tenantv1.Tenant{},
		resyncPeriod,
...
func (f *tenantInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&tenantv1.Tenant{}, f.defaultInformer)
}
