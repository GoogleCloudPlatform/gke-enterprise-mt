...
type ProviderConfigInterface interface {
	...
	UpdateStatus(ctx context.Context, providerConfig *v1.ProviderConfig, opts metav1.UpdateOptions) (*v1.ProviderConfig, error)
...
func (c *providerConfigs) UpdateStatus(ctx context.Context, providerConfig *v1.ProviderConfig, opts metav1.UpdateOptions) (result *v1.ProviderConfig, err error) {
	result = &v1.ProviderConfig{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("providerconfigs").
